...
if __name__ == '__main__':
    ...
    example of args for train_model.py
        ...
        --run_multiple_args_conditions train_model --classifier_name mlp --task node_classification  --enforce_end2end --use_phenotype_gene_disease_graph --graph_edges_type phenotype_gene_disease_phenotype --use_saved_emb_file --dataset no --cv --k_fold 5
    """
    # TODO I just can't run the file for some unknown reason. here ever get printed ??
    # TODO
    #   > curently, we are using 3 type of graph with mlp classifer and 1 edge selected strategies ( top-percent)
