...
def run_lr_link_prediction(data, x_with_features, cross_validation, split,
    ...
    if cross_validation:
        ...
        assert split is not None, "split have to be explicitly specify in command argument (prevent sbutle error and encorgae more explicit command arugment)"
        run_lr_using_test_train_split_with_link_prediction(data, x_with_features, task,splitted_edges_dir,
