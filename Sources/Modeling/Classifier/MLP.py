...
def run_mlp_using_test_train_split(data, data_with_features, split, task):
    """
#
    @param X: numpy
    @param y: numpy
...
def run_mlp_for_each_fold(x_train_with_features,
...
def run_mlp_using_cross_validation(data, data_with_features, k_fold,
    ...
    run_clf_using_cross_validation(data, data_with_features, k_fold,
                                   ...
                                   run_clf_for_each_fold=run_mlp_for_each_fold,
                                   task=task,
                                   edges_as_data=False,
                                   split_by_node=split_by_node
                                   )

def run_mlp_node_classification(data,
                               x_with_features,
                               cross_validation,
                               split,
                               k_fold,
    ...
    if cross_validation:
        ...
        run_mlp_using_cross_validation(data, x_with_features, k_fold,
        ...
        run_mlp_using_test_train_split(data, x_with_features, split, task)


def run_mlp(data=None, x_with_features=None, cross_validation=None,
    ...
    run_mlp_node_classification(data,
                               x_with_features,
                               cross_validation,
                               split,
                               k_fold,
