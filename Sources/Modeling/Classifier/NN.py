...
from Sources.Evaluation.evaluation import run_clf_using_cross_validation, report_performance
...
def run_neural_network_using_train_test_split(data, x_with_features, split,
                                              task):
    # =====================
    # ==parameter setting
    # =====================
    ...
    # (x_train, y_train), (x_test, y_test) = split_train_test(data, split, task)
    ...
    y_train_pred, y_train_pred_proba, y_test_pred, y_test_pred_proba =  run_neural_network_for_each_fold(x_train, x_test, y_train, y_test)
...
def run_neural_network(data,
    ...
    if cross_validation:
        ...
        run_neural_network_using_train_test_split(data, x_with_features, split,
                                                  task)
